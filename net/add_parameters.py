...
def add_params(tr):
    ...
    tr.f_add_parameter('netw.Vt_distributed',  prm.Vt_distributed)
    ...
    tr.f_add_parameter('netw.Vt_e_sigma',  prm.Vt_e_sigma)
    tr.f_add_parameter('netw.Vt_i_sigma',  prm.Vt_i_sigma)

    tr.f_add_parameter('netw.a_distributed', prm.a_distributed)
    ...
    tr.f_add_parameter('netw.a_ie_mean',  prm.a_ie_mean)
    tr.f_add_parameter('netw.a_ii_mean',  prm.a_ii_mean)
    tr.f_add_parameter('netw.a_ie_sigma',  prm.a_ie_sigma)
    tr.f_add_parameter('netw.a_ii_sigma',  prm.a_ii_sigma)
